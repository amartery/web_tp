...
class UserProfile(models.Model):
    ...
    image_profile = models.ImageField(blank=True, upload_to='avatar/%y/%m/%d', default='my_img.jpg')
...
class QuestionsDislikes(models.Model):
    ...
    def __str__(self):
        return self.user.nickname + ' поставил дизлайк "' + self.question.title + '"'
...
class AnswersDislikes(models.Model):
    ...
    def __str__(self):
        return self.user.nickname + ' поставил дизлайк "' + self.answer.question.title + '"'
